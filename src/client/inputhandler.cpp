...
void MyEventReceiver::reloadKeybindings()
{
	...
	keybindings[KeyType::DRONE_TOGGLE_HUD] = getKeySetting("keymap_drone_toggle_hud");
	keybindings[KeyType::DRONE_ROLL_LEFT] = getKeySetting("keymap_drone_roll_left");
	keybindings[KeyType::DRONE_ROLL_RIGHT] = getKeySetting("keymap_drone_roll_right");
	keybindings[KeyType::DRONE_CYCLE_WAYPOINT] = getKeySetting("keymap_drone_cycle_waypoint");
	keybindings[KeyType::DRONE_MAP_ZOOM_IN] = getKeySetting("keymap_drone_map_zoom_in");
	keybindings[KeyType::DRONE_MAP_ZOOM_OUT] = getKeySetting("keymap_drone_map_zoom_out");
	keybindings[KeyType::DRONE_TOGGLE_THIRD_PERSON] = getKeySetting("keymap_drone_toggle_third_person");
