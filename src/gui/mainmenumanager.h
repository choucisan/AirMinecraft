...
public:
	...
	virtual void toggleDroneMode() = 0;
	virtual void showNavDialog() = 0;
	virtual void showLargeMap() = 0;
};
...
public:
	...
	void toggleDroneMode() override
	{
		drone_toggle_requested = true;
	}

	void showNavDialog() override
	{
		nav_dialog_requested = true;
	}

	void showLargeMap() override
	{
		show_large_map_requested = true;
	}
	...
	bool drone_toggle_requested = false;
	bool nav_dialog_requested = false;
	bool show_large_map_requested = false;
