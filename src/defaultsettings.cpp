...
void set_default_settings()
{
	...
	settings->setDefault("keymap_drone_toggle", "SYSTEM_SCANCODE_25"); // KEY_KEY_V
	settings->setDefault("keymap_drone_view_next", "SYSTEM_SCANCODE_47"); // KEY_RIGHTBRACKET
	settings->setDefault("keymap_drone_view_prev", "SYSTEM_SCANCODE_46"); // KEY_LEFTBRACKET
	settings->setDefault("keymap_drone_toggle_hud", "SYSTEM_SCANCODE_11"); // KEY_KEY_H
	settings->setDefault("keymap_drone_roll_left", "SYSTEM_SCANCODE_21"); // KEY_KEY_R
	settings->setDefault("keymap_drone_roll_right", "SYSTEM_SCANCODE_9"); // KEY_KEY_F
	settings->setDefault("keymap_drone_cycle_waypoint", "SYSTEM_SCANCODE_17"); // KEY_KEY_N
	settings->setDefault("keymap_drone_map_zoom_in", "SYSTEM_SCANCODE_46"); // KEY_EQUALS
	settings->setDefault("keymap_drone_map_zoom_out", "SYSTEM_SCANCODE_45"); // KEY_MINUS
	settings->setDefault("keymap_drone_toggle_third_person", "SYSTEM_SCANCODE_23"); // KEY_KEY_T
	settings->setDefault("drone_show_info_panel", "true");
	settings->setDefault("drone_mode_on_start", "false");
